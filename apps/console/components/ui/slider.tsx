  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          'bg-muted relative grow overflow-hidden rounded-full border data-[orientation=horizontal]:h-1.5 data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-1.5',
        )}
      >
