...
/**
 * Scaled full-bleed backdrop take: 1.5× logo + headline, no supporting
 * copy, CTAs anchored at the center bottom of the hero.
 */
const HeroImageBackdropScaled = () => {
  return (
...
export default HeroImageBackdropScaled
